...
**Created**: 2026-01-05  
**Status**: Draft  
**Input**: User description + 論文草案（JCCJ Letter v8）: "計算化学の学生/研究者向けに構造の可視化・編集を効率化するツール。2構造(A/B)の同時編集、表面転写（薄いスラブ→厚いスラブ）や断片タイル合成による複合スーパーセル構築、対応原子距離のQC、格子パラメータ変換を中心機能とする。Quantum ESPRESSOの.inをターゲット。まずは座標・原子種のみ扱う。"
...
- **FR-012**: 解析・編集の主要処理は FastAPI + ASE/pymatgen で実施できる
