...
| Queue target ownership and selection behavior (`fakeredis`) | Tier-1 | Redis mocked; no Slurm runtime dependency | `uv run pytest apps/api/tests/test_runtime_targets.py` |
