...
- Sub-agent lane handoff should follow `docs/process/subagent-lane-handoff-template.md`.
...
- If a lane has no heartbeat for 30+ minutes during active review/CI, mark lane stale and reassign or recover before opening a new lane in that slot.
