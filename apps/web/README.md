...
- Optional E2E smoke: `pnpm -C apps/web test:e2e`
- Playwright smoke is part of deep local quality checks; run `pnpm -C apps/web test:e2e:install` before first run.
